...
async def test_demo_tour_all_pass(mock_dirs):
    ...
    # All 8 pass when fastmcp is installed; 7 pass + 1 skipped otherwise
    assert (
        "All 8 feature areas passed" in all_output
        or "7 feature areas passed, 1 skipped" in all_output
    )
